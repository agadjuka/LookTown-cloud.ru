"""
Сервис для чтения данных об услугах из облачного хранилища Cloud.ru
"""
import os
...
class ServicesDataLoader:
    """Загрузчик данных об услугах из Cloud.ru Object Storage"""
    ...
    def load_data(self) -> Dict:
        """
        Загрузка данных об услугах из Cloud.ru Object Storage
        ...
        storage_path = os.getenv('SERVICES_STORAGE_PATH', 'services.json')
