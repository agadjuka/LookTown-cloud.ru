...
1. Если клиент явно выбирает услугу (например, 'Хочу вторую', 'Запиши на стрижку'), и ты можешь понять ID из контекста истории или названия — извлеки `service_id` (int) или хотя бы `service_name` (str).
...
5. Если клиент выбирает мастера — извлеки `master_id` (int) или `master_name` (str).
